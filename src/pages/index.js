  ...
  const schemaMarkup = {
    ...
    lodgingUnit: [
      ...
      },
      {
        ...
        description:
          "Our spacious one bedroom suite features a private bedroom with a queen-size bed and a pull-out sofa in the living room. The fully equipped kitchenette and dining area make it easy to cook meals during your stay. The suite also has a window with stunning mountain views.",
        image: "http://www.example.com/casa-patron/one-bedroom-suite.jpg",
        numberOfRooms: 1,
        occupancy: 2,
        bed: {
      ...
      },
      {
        ...
        name: "Bunk Room",
        description:
          "A bunk room with two full size bunk beds, and two single bunks for a total of six occupants.",
        image: "http://www.example.com/casa-patron/one-bedroom-suite.jpg",
        numberOfRooms: 2,
        occupancy: 6,
        bed: {
