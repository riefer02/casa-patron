...
const MyH1 = props => <h1 className="font-bold text-3xl lg:text-4xl py-2" {...props} />
const MyH2 = props => <h2 className="font-medium text-2xl lg:text-3xl py-2" {...props} />
...
const MyOrderedList = props => <ol className="list-decimal ml-6 lg:ml-10" {...props} />
