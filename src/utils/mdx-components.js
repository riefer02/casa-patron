...
const MyH1 = props => (
  <h1 className="font-bold text-3xl lg:text-4xl py-2 pb-4" {...props} />
)
const MyH2 = props => (
  <h2 className="font-medium text-2xl lg:text-3xl py-2" {...props} />
)
const MyH3 = props => <h3 className="text-xl lg:text-2xl py-2" {...props} />
const MyP = props => <p className="text-base pb-2" {...props} />
const MyLink = props => (
  <a className="text-secondary hover:underline" {...props} />
)
const MyList = props => <ul className="list-disc ml-6 lg:ml-10 pb-2" {...props} />
